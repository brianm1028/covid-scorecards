...
#        cache.set('district' + str(district_id), ddc)
    ...
    return render_template('admin/index.html', data=DistrictDataCache(district_id),session=session)
...
#        cache.set('district' + str(district_id), ddc)
    ...
    return render_template('admin/'+section+'_config.html', data=DistrictDataCache(district_id),session=session)
